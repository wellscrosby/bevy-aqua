...
//!
//! Settings come from [`aqua_core::OceanWaves`].
...
use aqua_core::{BedHeightMap, OceanWaves, WaveModel};
...
/// ([`aqua_core::CascadeDataReady`] and [`aqua_core::CascadeMaterialsUpdated`]).
...
impl Plugin for AquaWavesPlugin {
    fn build(&self, app: &mut App) {
        ...
        let displace = app
            ...
            .load("embedded://aqua_waves/displace.wgsl");
        ...
        let stockham = app
            ...
            .map(|mut shaders| {
                shaders.add(Shader::from_wgsl(
                    aqua_fft::STOCKHAM_WGSL,
                    "aqua-fft/stockham.wgsl",
                ))
            });
        ...
        app.add_systems(
            ...
            update
                ...
                .after(aqua_core::WaterBodiesResolved),
        );
    }
}

const SHADER_PATH: &str = "embedded://aqua_waves/anim_waves.wgsl";
const COMBINE_SHADER_PATH: &str = "embedded://aqua_waves/anim_waves_combine.wgsl";
const GATHER_SHADER_PATH: &str = "embedded://aqua_waves/anim_waves_gather.wgsl";
const FFT_EVOLVE_SHADER_PATH: &str = "embedded://aqua_waves/fft_evolve.wgsl";
const FFT_RESOLVE_SHADER_PATH: &str = "embedded://aqua_waves/fft_resolve.wgsl";
const FFT_SURFACE_SHADER_PATH: &str = "embedded://aqua_waves/fft_surface.wgsl";
...
impl Frame {
    ...
    pub fn uniform(&self) -> &aqua_core::AnimWavesUniform {
        &self.uniform
    }
