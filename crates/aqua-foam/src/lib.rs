...
//! through [`aqua_core::AnimWavesStatus`]) and publishes one density array
...
use aqua_core::{CascadeDataReady, CascadeMaterialsUpdated};
use aqua_core::{LOD_COUNT, OceanWaves, WaveModel};
    ...
    fn build(&self, app: &mut App) {
        ...
        let contract = app
            ...
            .add(Shader::from_wgsl(
                FOAM_CONTRACT_WGSL,
                "aqua_foam/contract.wgsl",
            ));
        let shade = app
            .world()
            .resource::<AssetServer>()
            .load("embedded://aqua_foam/shade.wgsl");
...
const SHADER_PATH: &str = "embedded://aqua_foam/foam.wgsl";
